...
<head>
  ...
  <link rel="shortcut icon" href="asset/internal/img/img-local/papi.jpeg">
...
<body>
  ...
  <div class="page-wrap">
    <div class="header">
      <div class="box-1">
        <h1 disabled>Welcome to BANK SAMPAHKU</h1>
        <p> Bank sampah adalah suatu tempat yang digunakan untuk mengumpulkan sampah yang sudah dipilah-pilah.
          <br>Hasil dari pengumpulan sampah yang sudah dipilah akan disetorkan ke tempat pembuatan kerajinan dari sampah atau ke tempat Pengepul sampah.
          <br> Bank sampah dikelola menggunakan sistem seperti perbankkan yang dilakukan oleh petugas sukarelawan.
        </p>
        </p>
        <br> <br>
  ...
  <div id="foo">
    <section class="team">
      <div class="container">
        <div class="row">
          <h1>TERTARIK BERGABUNG BANK SAMPAHKU ???</h1>
          <p>Bank sampah adalah suatu tempat yang digunakan untuk mengumpulkan sampah yang sudah dipilah-pilah. Hasil dari pengumpulan sampah yang sudah dipilah akan disetorkan ke tempat pembuatan kerajinan dari sampah atau ke tempat Pengepul sampah. Bank sampah dikelola menggunakan sistem seperti perbankkan yang dilakukan oleh petugas sukarelawan.
            ...
            <br>Berikut ini tahapan proses BANK SAMPAHKU
          </p>
        </div>
  ...
  <footer class="footer-distributed">
    ...
    <div class="footer-left">
      ...
      <ul>
        ...
        <p>
          <font color="white">Copyright &#169; <script type='text/javascript'>
    ...
    <div class="footer-center">
      ...
      <div>
        ...
        <p><span>Desa xxx</span> Kecamatan xxx, Kabupaten xx.</p>
      </div>

      <div>
        <i class="fa fa-phone"></i>
        <p><a href="sms:(+62)85694519585">(+62)821 2716 2178</a></p>
      </div>

      <div>
        <i class="fa fa-envelope"></i>
        <p><a href="mailto:Official_bsk09@gmail.com">banksampahku@gmail.com</a></p>
      </div>
